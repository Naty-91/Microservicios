...
/**
 * Controlador global para manejar errores HTTP y redirigir a páginas de error personalizadas.
 * Este controlador detecta los códigos de estado de los errores comunes (403, 404, 500)
 * y redirige a plantillas específicas, proporcionando una experiencia de usuario más amigable.
 * También maneja otros errores no especificados, redirigiendo a una página de error genérica.
 */
@Controller
public class GlobalErrorController implements ErrorController {
    ...
    /**
     * Maneja las solicitudes a la ruta "/error" y redirige a la página de error correspondiente
     ...
     * @return La vista de error correspondiente según el código de estado, o una vista de error genérica
