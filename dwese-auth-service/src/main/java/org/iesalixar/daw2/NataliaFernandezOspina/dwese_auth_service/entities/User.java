package org.iesalixar.daw2.NataliaFernandezOspina.dwese_auth_service.entities;
 ...
 * Contiene campos para almacenar información de autenticación y perfil del usuario,
 * incluyendo username, password, estado de habilitación, nombre, apellido e imagen de perfil.
 * Además, cuenta con campos de auditoría como la fecha de creación, última modificación
